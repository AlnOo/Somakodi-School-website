...
const LINKS = [
  {
    title: "Somakodi",
    items: ["About Us", "Courses", "Careers", "Blog"],
  },
  {
    title: "Pages",
    items: ["Apply", "Register", "Financial Aid", "Scholarship"],
  },
  {
    title: "Socials",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 !w-full ">
          ...
          <div className="">
            ...
            <Typography className="!text-gray-500 font-normal mb-4 text-base">
              Get first access to our exclusive Tech events and be the first who gets
              informed about Financial Aid offers.
            </Typography>
